...
function page() {
  return (
    <>
      <section className="w-full flex text-white justify-center items-center h-[80vh] bg-[url('https://mauryascuisine.com/wp-content/uploads/2022/06/pattern-banner-1.jpg')]">
      ...
      <section className="h-fit max-w-[1250px] mx-auto md:p-20 p-6 text-left ">
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          you, whether personally or on behalf of an entity (“you”) and Maurya’s
          Restaurant, Bar & Banquet (“Company,” “we,” “us,” or “our”),
          concerning your access to and use of the
          https://www.mauryascuisine.com/ website as well as any other media
          ...
          are registered in Canada and have our registered office at 165
          Victoria Street, Kamloops, British Columbia V2C 1Z4. You agree that by
          ...
          if and to the extent local laws are applicable. The Site is intended
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          <span class="text-black">1.</span> The creation, distribution,
          ...
          third party. <br />
          <span class="text-black">2.</span> You are the creator and owner of or
          ...
          <span class="text-black">3.</span> You have the written consent,
          ...
          of your Contributions in any manner contemplated by the Site and these
          Terms of Use.
          <br />
          <span class="text-black">4.</span> Your Contributions are not false,
          inaccurate, or misleading.
          <br />
          <span class="text-black">5.</span> Your Contributions are not
          ...
          solicitation.
          <br />
          <span class="text-black">6.</span> Your Contributions are not obscene,
          lewd, lascivious, filthy, violent, harassing, libelous, slanderous, or
          otherwise objectionable (as determined by us).
          <br />
          <span class="text-black">7.</span> Your Contributions do not ridicule,
          mock, disparage, intimidate, or abuse anyone.
          <br />
          <span class="text-black">8.</span> Your Contributions are not used to
          ...
          people.
          <br />
          <span class="text-black">9.</span> Your Contributions do not violate
          any applicable law, regulation, or rule.
          <br />
          <span class="text-black">10.</span> Your Contributions do not violate
          the privacy or publicity rights of any third party.
          <br />
          <span class="text-black">11.</span> Your Contributions do not violate
          any applicable law concerning child pornography, or otherwise intended
          to protect the health or well-being of minors.
          <br />
          <span class="text-black">12.</span> Your Contributions do not include
          any offensive comments that are connected to race, national origin,
          gender, sexual preference, or physical handicap.
          <br />
          <span class="text-black">13.</span> Your Contributions do not
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          Policy: https://www.mauryascuisine.com/privacy-policy. By using the
          ...
          hosted in Canada. If you access the Site from any other region of the
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          Canada. Maurya’s Restaurant, Bar & Banquet and yourself irrevocably
          consent that the courts of Canada shall have exclusive jurisdiction to
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          <p className="text-3xl font-bold mb-4 tracking-wider">
          ...
          Kamloops, Canada. The language of the proceedings shall be English.
          The governing law of the contract shall be the substantive law of
          Canada.
          <p className="text-3xl font-bold mb-4 tracking-wider">Restrictions</p>
      ...
      <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
        ...
        <p className="text-3xl font-bold mb-4 tracking-wider">
          Maurya’s Restaurant, Bar & Banquet <br />
          165 Victoria Street <br />
          Kamloops, British Columbia V2C 1Z4 <br />
          Canada <br />
          Phone: 250-377-4969 <br />
        </p>
      </p>
      </section>
    </>
