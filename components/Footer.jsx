          ...
          <div className="flex md:flex-row flex-col gap-7 mt-10 justify-center items-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-center">
                <button onClick={toggleSubscribe} className="bg-transparent p-4 px-10 text-lg font-bold border-[1px] border-[#d88728] text-[#d88728] hover:text-white hover:bg-[#d88728] transition-all duration-400">
                  Subscribe
                </button>
              </div>
              <div className="flex gap-4 justify-center items-center">
                <Link className="text-sm underline" href="/terms-and-conditions">Terms & Conditions</Link>
                <Link className="text-sm underline" href="/privacy-policy">Privacy Policy</Link>
              </div>
            </div>
          </div>
        </div>
