...
function page() {
  return (
    <>
      <section className="w-full flex text-white justify-center items-center h-[80vh] bg-[url('https://mauryascuisine.com/wp-content/uploads/2022/06/pattern-banner-2.jpg')]">
      ...
      <section className="h-fit max-w-[1250px] mx-auto md:p-20 p-6 text-left ">
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          provide (“Personal Information”) on the mauryascuisine.com website
          ...
          and this Website operator (“Operator”, “we”, “us” or “our”). If you
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          provide to us when you fill any forms on the Website. When required,
          this information may include contact information (such as email
          address, phone number, etc). You can choose not to provide us with
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          Information from our Services. We encourage parents and legal
          ...
          overseeing the care of children take the necessary precautions to
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          Website and Services. In such instances, we are a data controller
          because we determine the purposes and means of the processing of
          Personal Information. We act in the capacity of a data processor in
          ...
          controller. In order to make the Website and Services available to
          ...
          that we request, we may not be able to provide you with the requested
          products or services. Any of the information we collect from you may
          be used for the following purposes:
        </p>
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          <span className="text-black">1.</span> Respond to inquiries and offer
          support <br /> <span className="text-black">2.</span> Run and operate
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          pursued by us or by a third party. Note that under some legislations
          we may be allowed to process information until you object to such
          processing by opting out, without having to rely on consent or any
          other of the legal bases. In any case, we will be happy to clarify the
        ...
        <p className="text-5xl font-extrabold mb-8 tracking-wider">Cookies</p>
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          the cookie to you. Click here to learn more about cookies and how they
          work. We may use cookies to collect, store, and track information for
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          Some e offer electronic newsletters to which you may voluntarily
          subscribe at any time. We are committed to keeping your e-mail address
          ...
          accordance with applicable laws and regulations. In compliance with
          the CAN-SPAM Act, all e-mails sent from us will clearly state who the
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          Policy unless otherwise specified. Your continued use of the Website
          and Services after the effective date of the revised Policy (or such
          other act specified at that time) will constitute your consent to
          those changes. However, we will not, without your consent, use your
        ...
        <p className="text-xl font-semibold text-left tracking-wider pr-6 leading-10 text-neutral-600 mb-8">
          ...
          policy was created with the <a className="text-[#d88728]" href="https://www.websitepolicies.com/privacy-policy-generator">privacy policy generator.</a>  We will attempt
          to resolve complaints and disputes and make every reasonable effort to
          honour your wish to exercise your rights as quickly as possible and in
          any event, within the timescales provided by applicable data
          protection laws. This document was last updated on July 8, 2022
        </p>
      </section>
    </>
  );
