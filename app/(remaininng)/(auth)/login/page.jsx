  ...
  return (
    <div className="h-[80vh] flex flex-row">
      <div className="w-2/3 md:flex justify-center flex-col gap-5 items-center text-center text-white hidden bg-[url('https://www.cactusclubcafe.com/wp-content/uploads/2024/11/111424_PDE_HolidayCampaign_PromoBlock_1200x800.jpg')]">
        ...
        <p className="text-2xl font-semibold">More Than a Meal – It’s an Experience.</p>
      </div>
      <div className="w-full md:w-1/3 flex flex-col justify-center items-center p-3">
        <div className="flex flex-col w-fit justify-center items-center p-4">
          ...
          <div>
            <p className="text-2xl font-extrabold text-[#d88728] text-center">Welcome Back!</p>
            <p className="text-xl font-bold text-center">Log into your account</p>
            <form onSubmit={handleSubmit} className="flex flex-col w-full">
              <input
                className="rounded-2xl w-full pr-16 border-[1px] font-semibold border-black flex justify-center items-center gap-2 px-4 py-2 mb-2 mt-2"
                type="email"
                placeholder="Email"
                value={email}
            ...
            {error && (
              <p className="text-center text-base -mt-2 text-red-500">{error}</p>
            )}
            <p className="text-sm text-center font-semibold">
              Don't have an account?{" "}
              <Link href="/signup" className="text-[#d88728] cursor-pointer">
                Signup
              </Link>
            </p>
          </div>
